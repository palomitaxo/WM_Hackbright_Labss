...
/*
  ...
  Then invoke the callback, passing in the last element in the array as
  the argument.
*/
...
/* 
  Write a function called each that takes in an array of names and a 
  callback function. 
...
/*
  Write a function called getUserById that takes in three parameters: an array of
   objects (users), an id and a callback, and searches for the user with a 
   matching id.
...
const addFavoriteNumber = addingFactory(444);

console.log(addFavoriteNumber(10));
console.log(addFavoriteNumber(25));